...
This repository is dedicated to introducing geometry in game development. For this reason some standard methods from mathematical library of the Godot Engine are reimplemented in GDScript for purpose of education.
